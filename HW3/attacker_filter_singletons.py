...
class RND(BaseAttack):
    ...
    def attack(self, ori_features, ori_adj, labels, idx_train, w1, w2, target_node, n_perturbations, **kwargs):
        ...
        for _ in range(n_perturbations):
            ...
            #singleton_filter = filter_singletons(potential_edges, adj) 
            ...
            deltas = 2 * (1 - adj[tuple(filtered_edges.T)].toarray()[0] )- 1
            ...
            a_hat_uv_new = self.compute_new_a_hat_uv(filtered_edges_final, adj, adj_preprocessed, target_node, N) 
        ...
        #logits_start = adj_preprocessed.dot(self.adj_preprocessed).dot(self.X_obs.dot(self.W))[self.u].toarray()[0]
        ...
        if remain >= 0:
            ...
            # if you want to perturb feature, you can do somethind like below
            # random_choosed_feature = (2109, 3640)
            # modified_features[choosed_feature] = 1 - modified_features[choosed_feature]
        """
